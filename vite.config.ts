...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      //asegura que el service worker se registre automaticamente al iniciar la app, tanto en desarrollo como en produccion
      injectRegister: "auto",
      includeAssets: ["/android", "/ios", "/windows11"],
      manifest: {
        name: "ANDON APP",
        short_name: "PWA ANDON APP",
        description: "PWA FOR DESKTOP ANDON APP",
        theme_color: "#ffffff",
        display_override: [
          "fullscreen",
          "minimal-ui",
